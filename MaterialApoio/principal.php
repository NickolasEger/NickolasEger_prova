...
$permissoes = [
    ...
    4 => [
        ...
        "Alterar"   => ["alterar_produto.php"]
    ]
];

// OBTENDO AS OPÇÕES DISPONÍVEIS PARA O PERFIL LOGADO
$id_perfil = $_SESSION['id_perfil']; // ou qualquer variável que contenha o ID do perfil
...
<body>
    ...
    <nav>
        <ul class="menu">
            <?php foreeach($opcoes_menu as $categoria =>$arquivos);?>
            <li class="dropdown">
                <a href="#"><?=$categoria?></a>
                <ul class="dropdown-menu">
                    <?php foreeach($arquivos as $arquivo);?>
                    <li>
                        <a href="<? $arquivo?>"<?=ucfirst(str_replace("_","",basename($arquivos,".php")))?>></a>
                    </li>
                    <?php foreach;?>
                </ul>
            </li>
